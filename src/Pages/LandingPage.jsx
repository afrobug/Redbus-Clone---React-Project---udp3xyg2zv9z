  ...
  return (
    <div>
      <div className={styles.welcome_image}>
        {/* <Form handleAddForm={handleAddForm}></Form> >>>> Search buses */}

        <div>
          <div className={styles.prompt_a}>
            {" "}
            <div className={styles.prompt1}>
              SAVE THE DRAMA FOR THE STAGE!
            </div>{" "}
            <div className={styles.prompt2}>
              Book your favourite seat online with redBus.
            </div>{" "}
          </div>
        </div>
      </div>
      ...
      <div className={styles.safety}>
        ...
        <div>
          <span className={styles.f1}>
            ...
            <div className={styles.subtext_hero}>
              ...
              <a className={styles.know_more_anchor} href="/SafetyPlus">
                &nbsp;Know more
              </a>
            </div>
        ...
        <div className={styles.order}>
          <div className={styles.info_hero}>
            ...
            <div className={styles.value_hero}>
              {" "}
              <br />
            </div>
          ...
          <div className={styles.info_hero3}>
            ...
            <div className={styles.text_hero}>
              All passengers will undergo thermal screening. Temperature checks
              for bus drivers and service staff are done before every trip.{" "}
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={styles.pict}>
        <div>
          <div className={styles.pic}>
            <div className={styles.text1}>
              <div className={styles.heading1}>Convenience On-the-go.</div>
              <br />
              <div className={styles.opd}>
                {" "}
                Enjoy the following exclusive features on the redBus app <br />
                <br />
                <span>Last Minute Booking</span> - In a hurry to book a bus at
                the last minute?Choose the bus passing from your nearest
                boarding point and book in a few easy steps.
                <br />
                <br />
                <span>Boarding Point Navigation</span> - Never lose your way
                while travelling to your boarding point! <br /> <br />
                <span>Comprehensive Ticket Details </span>- Everything that you
                need to make the travel hassle free - rest stop details,
                boarding point images, chat with co-passengers, wake-up alarm
                and much more!
              </div>
              <div>
                <br />
                <span className={styles.opd}>
                ...
                <div>
                  <div className={styles.btns}>
                    <br />
                    <select className={styles.IP} name="upphoneCode">
              ...
              <div>
                <span>
                  <a href="https://itunes.apple.com/in/app/redbus/id733712604?mt=8 target=_blank">
                    <img
                      src="//s2.rdbuz.com/web/images/home/sgp/iPhone_download.png"
                      alt=""
                    />
                  </a>
                </span>
                <span>
                  <a href="https://play.google.com/store/apps/details?id=in.redbus.android&amp;hl=en ">
                    <img
                      src="//s3.rdbuz.com/web/images/home/sgp/Google_download.png"
                      alt=""
                    />
                  </a>
                </span>
              ...
              <div>
                <a href="https://itunes.apple.com/in/app/redbus/id733712604?mt=8"></a>
                <a href="https://play.google.com/store/apps/details?id=in.redbus.android&amp;hl=en"></a>
              </div>
            </div>
          </div>
        ...
        <div className={styles.bgImgCont}>
          <img
            ...
            src="http://s2.rdbuz.com/web/images/home/city_scape_app_download.png"
            alt=""
          />
        </div>
      </div>
        ...
        <div>
          <div className={styles.prms3}>
            <div className={styles.prms2}>
              <div styles={styles.ig3}>
                <img
                  src="https://s3.rdbuz.com/Images/safety/srp/safety.svg"
                  alt="imag"
                />
              </div>
              <br />
      ...
      <div className={styles.aw}>
        <div className={styles.award}>AWARDS & RECOGNITION</div>
        <br />
        <br />
      ...
      <div>
        <div className={styles.flags}>
          ...
          <div className={styles.flag}>
            ...
            <div>
              <img
                src="https://cdn.britannica.com/48/1648-004-A33B72D8/Flag-Indonesia.jpg"
                alt="flag"
              />
              <p>INDONESIA</p>
            </div>
            ...
            <div>
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/d/df/Flag_of_Peru_%28state%29.svg"
                alt="flag"
              />
              <p>PERU</p>
            </div>
            <div>
              <img
                src="https://cdn.britannica.com/36/4036-004-710DB7F7/Flag-Singapore.jpg"
                alt="flag"
              />
              <p> SINGAPORE</p>
            </div>
      ...
      <div className={styles.bckgrd}>
        ...
        <div className={styles.mrgn}>
          ...
          <p className={styles.mrgn1}>
            SRS Travels | Evacay Bus | Kallada Travels | KPN Travels | Orange
            Travels | Parveen Travels | Rajdhani Express | VRL Travels |
            Chartered Speed Bus | Bengal Tiger | SRM Travels | Infant Jesus |
            Patel Travels | JBT Travels | Shatabdi Travels | Eagle Travels
            |Kanker Roadways | Komitla | Sri Krishna Travel | Humsafar Travels |
            Mahasagar Travels | |Raj Express | Sharma Travels | Shrinath Travels
            | Universal Travles | Verma Travel | Gujarat Travels | Madurai Radha
            Travels | Patel Tours and Travels | Paulo Travels | Royal Travels |
            Amarnath Travel |Vaibhav Travels | Ganesh Travels| Jabbar Travels |
            Jain Travel | Manish Travels | Pradhan Travels | YBM Travels |
            Hebron Transports | Mahalaxmi travels | MR Travels | Vivegam Travels
            | VST Travels| Jakhar Travels | Kaleswari Travels | Mahendra Travels
            | Neeta Tours and Travels | Yamani Travels | Arthi Travels A
          </p>
        </div>
        {/* <Footer/> */}
      </div>
